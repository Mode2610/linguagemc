...
//assim podemosacessar as propriedades  da estrutura cliente
struct Cliente cli;
//scanf("%s", cli.nome);
...
//Realizar a concatenação(junçãode elementos distintos)para
...
//idade do cliente.
// Utilizaremos um novo array de chars que iráguardar o número,agora no
//formato string. e, também usaremos o comando sprintf(Spring Print Format)
//o inicio do comando pede o array de chars para guardar o resultado
//da conversão , e segundo item do comando pede  o formato original do valor
// a ser convertido, neste caso %d decimal. E, o último valor é o número
